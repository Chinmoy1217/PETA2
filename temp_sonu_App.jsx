    ...
    <>
      ...
      <div className="card-grid" style={{ marginBottom: '1rem', gridTemplateColumns: 'repeat(3, 1fr)' }}>
        <div className="glass-card">
          <div className="stat-header"><span style={{ fontSize: '1.4rem', marginRight: '8px' }}>=ƒôª</span> Total Shipments</div>
          <div className="stat-value">{metrics.total_shipments?.toLocaleString()}</div>
        </div>
        <div className="glass-card">
          <div className="stat-header"><span style={{ fontSize: '1.4rem', marginRight: '8px' }}>G£à</span> On-Time Delivery %</div>
          <div className="stat-value" style={{ color: '#10b981' }}>{metrics.on_time_rate}%</div>
          <div className="sub-text">ETA Accuracy</div>
        </div>
        <div className="glass-card">
          <div className="stat-header"><span style={{ fontSize: '1.4rem', marginRight: '8px' }}>=ƒòÆ</span> Late Shipments</div>
        ...
        <div className="glass-card">
          <div className="stat-header"><span style={{ fontSize: '1.4rem', marginRight: '8px' }}>GÅ¦</span> Avg Delay</div>
          <div className="stat-value" style={{ color: '#f59e0b' }}>{metrics.avg_delay_days} days</div>
        </div>
        <div className="glass-card">
          <div className="stat-header"><span style={{ fontSize: '1.4rem', marginRight: '8px' }}>=ƒÜ¿</span> Max Delay</div>
          <div className="stat-value" style={{ color: '#ef4444' }}>{metrics.max_delay_days} days</div>
        </div>
        <div className="glass-card">
          <div className="stat-header"><span style={{ fontSize: '1.4rem', marginRight: '8px' }}>GÜán+Å</span> Critical Delays</div>
      ...
      <div className="card-grid" style={{ marginBottom: '1rem', gridTemplateColumns: 'repeat(3, 1fr)' }}>
        <div className="glass-card">
          <div className="stat-header"><span style={{ fontSize: '1.4rem', marginRight: '8px' }}>=ƒöä</span> Avg Variance</div>
          <div className="stat-value">{metrics.avg_eta_variance_days} days</div>
        </div>
        <div className="glass-card">
          <div className="stat-header"><span style={{ fontSize: '1.4rem', marginRight: '8px' }}>=ƒÜÇ</span> Early Arrivals</div>
          <div className="stat-value" style={{ color: '#3b82f6' }}>{metrics.early_arrival_rate}%</div>
        </div>
        <div className="glass-card">
          <div className="stat-header"><span style={{ fontSize: '1.4rem', marginRight: '8px' }}>=ƒÄ»</span> On-Time Arrivals</div>
